ntkrnlmp_types= {
  ...
  '_KTHREAD' : [ 0x5e0, {
    'Header' : [ 0x0, ['_DISPATCHER_HEADER']],
    'SListFaultAddress' : [ 0x18, ['pointer', ['void']]],
    'QuantumTarget' : [ 0x20, ['unsigned long long']],
    'InitialStack' : [ 0x28, ['pointer', ['void']]],
    'StackLimit' : [ 0x30, ['pointer', ['void']]],
    'StackBase' : [ 0x38, ['pointer', ['void']]],
    ...
    'KernelStack' : [ 0x58, ['pointer', ['void']]],
    'StateSaveArea' : [ 0x60, ['pointer', ['_XSAVE_FORMAT']]],
    'SchedulingGroup' : [ 0x68, ['pointer', ['_KSCHEDULING_GROUP']]],
    ...
    'FirstArgument' : [ 0x88, ['pointer', ['void']]],
    'TrapFrame' : [ 0x90, ['pointer', ['_KTRAP_FRAME']]],
    ...
    'WaitBlockList' : [ 0xd0, ['pointer', ['_KWAIT_BLOCK']]],
    'WaitListEntry' : [ 0xd8, ['_LIST_ENTRY']],
    'SwapListEntry' : [ 0xd8, ['_SINGLE_LIST_ENTRY']],
    'Queue' : [ 0xe8, ['pointer', ['_DISPATCHER_HEADER']]],
    'Teb' : [ 0xf0, ['pointer', ['void']]],
    ...
    'ThreadCounters' : [ 0x168, ['pointer', ['_KTHREAD_COUNTERS']]],
    'WaitBlockFill9' : [ 0x140, ['array', 88, ['unsigned char']]],
    'XStateSave' : [ 0x198, ['pointer', ['_XSTATE_SAVE']]],
    'WaitBlockFill10' : [ 0x140, ['array', 136, ['unsigned char']]],
    'Win32Thread' : [ 0x1c8, ['pointer', ['void']]],
    'WaitBlockFill11' : [ 0x140, ['array', 176, ['unsigned char']]],
    'Ucb' : [ 0x1f0, ['pointer', ['_UMS_CONTROL_BLOCK']]],
    'Uch' : [ 0x1f8, ['pointer', ['_KUMS_CONTEXT_HEADER']]],
    'TebMappedLowVa' : [ 0x200, ['pointer', ['void']]],
    ...
    'Process' : [ 0x220, ['pointer', ['_KPROCESS']]],
    ...
    'WaitPrcb' : [ 0x2c8, ['pointer', ['_KPRCB']]],
    'SchedulerApcFill4' : [ 0x288, ['array', 72, ['unsigned char']]],
    'LegoData' : [ 0x2d0, ['pointer', ['void']]],
  ...
  '_ETHREAD' : [ 0x7e0, {
    ...
    'OwnsProcessAddressSpaceExclusive' : [ 0x6c8, ['BitField', dict(start_bit = 0, end_bit = 1, native_type='unsigned long')]],
    'OwnsProcessAddressSpaceShared' : [ 0x6c8, ['BitField', dict(start_bit = 1, end_bit = 2, native_type='unsigned long')]],
    'HardFaultBehavior' : [ 0x6c8, ['BitField', dict(start_bit = 2, end_bit = 3, native_type='unsigned long')]],
    'StartAddressInvalid' : [ 0x6c8, ['BitField', dict(start_bit = 3, end_bit = 4, native_type='unsigned long')]],
    'EtwCalloutActive' : [ 0x6c8, ['BitField', dict(start_bit = 4, end_bit = 5, native_type='unsigned long')]],
    'SuppressSymbolLoad' : [ 0x6c8, ['BitField', dict(start_bit = 5, end_bit = 6, native_type='unsigned long')]],
    'Prefetching' : [ 0x6c8, ['BitField', dict(start_bit = 6, end_bit = 7, native_type='unsigned long')]],
    'OwnsVadExclusive' : [ 0x6c8, ['BitField', dict(start_bit = 7, end_bit = 8, native_type='unsigned long')]],
    'SystemPagePriorityActive' : [ 0x6c9, ['BitField', dict(start_bit = 0, end_bit = 1, native_type='unsigned long')]],
    'SystemPagePriority' : [ 0x6c9, ['BitField', dict(start_bit = 1, end_bit = 4, native_type='unsigned long')]],
  ...
  '_EPROCESS' : [ 0x7b0, {
    ...
    'ExceptionPortState' : [ 0x350, ['BitField', dict(start_bit = 0, end_bit = 3, native_type='unsigned long')]],
  ...
  '_MI_SYSTEM_PTE_TYPE' : [ 0x60, {
    ...
    'Vm' : [ 0x38, ['pointer64', ['_MMSUPPORT_FULL']]],
  ...
  '_MMWSL_INSTANCE' : [ 0x1a0, {
    ...
    'ActiveWsleCounts' : [ 0x20A, ['array', 16, ['unsigned long long']]],
    'ActiveWsles' : [ 0xa0A, ['array', 16, ['_MI_ACTIVE_WSLE_LISTHEAD']]],
} ],
  '_MMWSL_SHARED' : [ 0x60, {
  ...
  '_IOP_IRP_EXTENSION' : [ 0x38, {
    ...
    'DiskIoAttributionHandle ' : [ 0x010, ['unsigned long long']],
  ...
  '_WMI_LOGGER_CONTEXT' : [ 0x440, {
    ...
    'GetCpuClock' : [ 0x28, ['pointer64', ['long long']]],
  ...
  '_DEVICE_MAP' : [ 0x40, {
    ...
    'ServerSilo' : [ 0x040, ['pointer64', ['_EJOB']]],
} ],
  ...
  '_PEB' : [ 0x7a0, {
    ...
    'AnsiCodePageData' : [ 0x0a0, ['pointer64', ['void']]],
    'OemCodePageData' : [ 0x0a8, ['pointer64', ['void']]],
    'UnicodeCaseTableData' : [ 0x0b0, ['pointer64', ['void']]],
    'NumberOfProcessors' : [ 0x0b8, ['unsigned long']],
    'NtGlobalFlag' : [ 0x0bc, ['unsigned long']],
    'CriticalSectionTimeout' : [ 0x0c0, ['_LARGE_INTEGER']],
    'HeapSegmentReserve' : [ 0x0c8, ['unsigned long long']],
    'HeapSegmentCommit' : [ 0x0d0, ['unsigned long long']],
    'HeapDeCommitTotalFreeThreshold' : [ 0x0d8, ['unsigned long long']],
    'HeapDeCommitFreeBlockThreshold' : [ 0x0e0, ['unsigned long long']],
    'NumberOfHeaps' : [ 0x0e8, ['unsigned long']],
    'MaximumNumberOfHeaps' : [ 0x0ec, ['unsigned long']],
    'ProcessHeaps' : [ 0x0f0, ['pointer64', ['pointer64', ['void']]]],
    'GdiSharedHandleTable' : [ 0x0f8, ['pointer64', ['void']]],
  ...
  '_IO_WORKITEM' : [ 0x58, {
    'WorkItem' : [ 0x0, ['_WORK_QUEUE_ITEM']],
    'Routine' : [ 0x20, ['pointer', ['void']]],
    'IoObject' : [ 0x28, ['pointer', ['void']]],
    'Context' : [ 0x30, ['pointer', ['void']]],
  ...
  '_POP_FX_WORK_ORDER_WATCHDOG_INFO' : [ 0x88, {
    'Timer' : [ 0x0, ['_KTIMER']],
    'Dpc' : [ 0x40, ['_KDPC']],
    'WorkOrder' : [ 0x80, ['pointer', ['_POP_FX_WORK_ORDER']]],
} ],
  '_MI_VAD_EVENT_BLOCK' : [ 0x40, {
    ...
    'LargePage' : [ 0x10, ['pointer64', ['_MI_LARGEPAGE_IMAGE_INFO']]],
...
'_VF_AVL_TREE_NODE_EX' : [ 0x18, {
  ...
  '_MI_HARDWARE_STATE' : [ 0x100, {
    ...
    'OptimalZeroingAttribute' : [ 0x78, ['array', 4, ['array', 4, ['Enumeration', dict(target = 'long', choices = {0: 'MiNonCached', 1: 'MiCached', 2: 'MiWriteCombined', 3: 'MiNotMapped'})]]]],
    'AttributeChangeRequiresReZero' : [ 0x0b8, ['unsigned char']],
    'ZeroCostCounts' : [ 0x0c0, ['array', 2, ['_MI_ZERO_COST_COUNTS']]],
    'PrimaryPfns' : [ 0x0e0, ['unsigned long long']],
    'HighestPossiblePhysicalPage' : [ 0x0e8, ['unsigned long long']],
    'EnclaveRegions' : [ 0x0f0, ['_RTL_AVL_TREE']],
    'VsmKernelPageCount' : [ 0x0f8, ['unsigned long long']],
} ],
'_PEBS_DS_SAVE_AREA' : [ 0x60, {
  ...
  '_PEB32' : [ 0x460, {
    ...
    'LoaderLock' : [ 0x0a0, ['unsigned long']],
    'OSMajorVersion' : [ 0x0a4, ['unsigned long']],
    'OSMinorVersion' : [ 0x0a8, ['unsigned long']],
    'OSBuildNumber' : [ 0x0ac, ['unsigned short']],
    'OSCSDVersion' : [ 0x0ae, ['unsigned short']],
    'OSPlatformId' : [ 0x0b0, ['unsigned long']],
    'ImageSubsystem' : [ 0x0b4, ['unsigned long']],
    'ImageSubsystemMajorVersion' : [ 0x0b8, ['unsigned long']],
    'ImageSubsystemMinorVersion' : [ 0x0bc, ['unsigned long']],
    'ActiveProcessAffinityMask' : [ 0x0c0, ['unsigned long']],
    'GdiHandleBuffer' : [ 0x0c4, ['array', 34, ['unsigned long']]],
  ...
  '_POP_POWER_ACTION' : [ 0x108, {
    ...
    'WakeAlarm' : [ 0x68, ['array', 3, ['__unnamed_24ec']]],
  ...
  '_CM_KCB_UOW' : [ 0x78, {
    ...
    'PrepareDataPointer ' : [ 0x068, ['pointer64', ['void']]],
  ...
  '_MI_POOL_FAILURE_REASONS' : [ 0x2c, {
    ...
    'PagedNoPtes' : [ 0x00c, ['unsigned long']],
  ...
  '__unnamed_2910' : [ 0x18, {
    ...
    'Sea' : [ 0x0, ['__unnamed_290e']],
    'Sei' : [ 0x0, ['__unnamed_290e']],
    'Gsiv' : [ 0x0, ['__unnamed_290e']],
} ],
  ...
  '_INTERRUPT_VECTOR_DATA' : [ 0x58, {
    ...
    'XapicMessage' : [ 0x48, ['__unnamed_2995']],
    'Hypertransport' : [ 0x48, ['__unnamed_2998']],
    'GenericMessage' : [ 0x48, ['__unnamed_2995']],
    'MessageRequest' : [ 0x48, ['__unnamed_299c']],
} ],
...
'_ETW_HASH_BUCKET' : [ 0x38, {
  ...
  '_PNP_REBALANCE_TRACE_CONTEXT' : [ 0x70, {
    ...
    'Reason' : [ 0x8, ['array', 2, ['_PNP_REBALANCE_REASON']]],
    'Failure' : [ 0x10, ['array', 2, ['_PNP_REBALANCE_FAILURE']]],
    ...
    'VetoQueryRebalanceReason' : [ 0x50, ['array', 2, ['_PNP_DEVNODE_QUERY_REBALANCE_VETO_REASON']]],
  ...
  '_SILO_USER_SHARED_DATA' : [ 0x20, {
    'ServiceSessionId' : [ 0x0, ['unsigned long']],
     ...
     'NtProductType' : [ 0x10, ['_NT_PRODUCT_TYPE']],
     'SuiteMask' : [ 0x14, ['unsigned long']],
     'IsMultiSessionSku' : [ 0x18, ['unsigned char']],
} ],
  '_CM_UOW_KEY_STATE_MODIFICATION' : [ 0x14, {
    'RefCount' : [ 0x0, ['unsigned long']],
    'SubKeyListCount' : [ 0x004, ['array', 2, ['unsigned long']]],
    'NewSubKeyList' : [ 0x00c, ['array', 2, ['unsigned long']]],
} ],
  ...
  '_RTL_HASH_TABLE' : [ 0x10, {
    ...
    'BucketCount' : [ 0x4, ['BitField', dict(start_bit = 5, end_bit= 23, native_type='unsigned long')]],
